[![Build Status](https://dev.azure.com/pt-iot/smartsite/_apis/build/status/csm.cloud.company.avro?branchName=master)](https://dev.azure.com/pt-iot/smartsite/_build/latest?definitionId=54?branchName=master)

# Introduction

This repo contains the event listener interface for the company messaging API and convenience classes usable in other 
