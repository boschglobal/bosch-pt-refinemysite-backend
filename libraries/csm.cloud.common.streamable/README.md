[![Build Status](https://dev.azure.com/pt-iot/smartsite/_apis/build/status/csm.cloud.common.streamable?branchName=master)](https://dev.azure.com/pt-iot/smartsite/_build/latest?definitionId=56?branchName=master)

# Introduction

This repo contains code for common functionality of those smartsite backend services that own certain data and stream this to kafka. It is based on spring jpa and hibernate.
