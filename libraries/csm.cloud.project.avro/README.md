[![Build Status](https://dev.azure.com/pt-iot/smartsite/_apis/build/status/csm.cloud.project.activities?branchName=master)](https://dev.azure.com/pt-iot/smartsite/_build/latest?definitionId=71?branchName=master)

# Introduction

This repo contains the event listener interface for the project messaging API and convenience classes usable in other 
modules to simplify the testing (event stream generator, event listener extensions, etc.).
