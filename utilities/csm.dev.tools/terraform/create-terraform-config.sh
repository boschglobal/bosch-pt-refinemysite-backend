...
DEV_SUBSCRIPTION_ID="96aa5728-e64f-4ee5-9fd8-e656f878aa03"
QA_SUBSCRIPTION_ID="cc9cf3a1-9bbc-4863-8d83-ad953737f26d"
PROD_SUBSCRIPTION_ID="d758dda6-675e-47a2-b269-866d5e4f918f"
SANDBOX_SUBSCRIPTION_ID="325fb91f-1c74-4ebf-80ff-cf8e0cc5ab66"
...
set_config() {
    ...
    "dev")
        ...
        SP_NAME=Azure-SP-PT-ENS-RefineMySite-Dev-AzureDevOps
        SUBSCRIPTION_ID=${DEV_SUBSCRIPTION_ID}
        ;;
    "prod")
        MONGODB_ATLAS_PROJECT=PT_RefinemySite_PROD_211972
        SP_NAME=Azure-SP-PT-ENS-RefineMySite-Prod-AzureDevOps
        SUBSCRIPTION_ID=${PROD_SUBSCRIPTION_ID}
        ;;
    "qa")
        MONGODB_ATLAS_PROJECT=PT_RefinemySite_DEV_211972
        SP_NAME=Azure-SP-PT-ENS-RefineMySite-QA-AzureDevOps
        SUBSCRIPTION_ID=${QA_SUBSCRIPTION_ID}
        ;;
    "sandbox")
        MONGODB_ATLAS_PROJECT=PT_RefinemySite_DEV_211972
        SP_NAME=Azure-SP-PT-ENS-RefineMySite-Sandbox-AzureDevOps
