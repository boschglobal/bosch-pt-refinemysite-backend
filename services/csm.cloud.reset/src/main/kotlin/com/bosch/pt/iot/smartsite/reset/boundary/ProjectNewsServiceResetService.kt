...
@Service
class ProjectNewsServiceResetService(
    jdbcResetStrategy: JdbcResetStrategy,
    @Qualifier("newsJdbcTemplate") jdbcOperations: JdbcOperations
) :
    AbstractRelationalDatabaseResetService(jdbcResetStrategy, jdbcOperations, "news-service"),
    Resettable
