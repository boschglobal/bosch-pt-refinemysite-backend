...
package com.bosch.pt.csm.cloud.pdf.common.facade.rest
...
class ErrorController(
  ...
  @ExceptionHandler(TimeoutError::class)
  fun handleClientAbortException(ex: TimeoutError): ResponseEntity<Void> {
    MDC.put(RESPONSE_HTTP_STATUS_CODE, REQUEST_TIMEOUT.value().toString())
    logError("Request to fetch HTML source timed out", ex)
    MDC.remove(RESPONSE_HTTP_STATUS_CODE)
