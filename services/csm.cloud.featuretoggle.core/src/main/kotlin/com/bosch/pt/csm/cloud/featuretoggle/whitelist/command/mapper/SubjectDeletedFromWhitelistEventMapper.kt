...
@Component
class SubjectDeletedFromWhitelistEventMapper : FeaturetoggleAvroEventMapper {
  override fun canMap(event: Any): Boolean = event is SubjectDeletedFromWhitelistEvent

  override fun mapToKey(event: Any, version: Long): AggregateEventMessageKey {
    require(event is SubjectDeletedFromWhitelistEvent)
  ...
  override fun mapToValue(event: Any, version: Long): SpecificRecordBase {
    ...
    return SubjectDeletedFromWhitelistEventAvro.newBuilder()
        .apply {
