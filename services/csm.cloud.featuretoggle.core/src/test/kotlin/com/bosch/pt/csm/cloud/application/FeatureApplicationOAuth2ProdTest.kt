...
@WebAppConfiguration
@ActiveProfiles("test", "idp-bosch-prod", "event-listener-disabled")
@MySqlTest
class FeatureApplicationOAuth2ProdTest {
  ...
  fun contextLoads() {
    ...
    assertThat(resource.issuerUris)
        .isEqualTo(listOf("https://p36.authz.bosch.com/auth/realms/central_profile"))
  }
}
