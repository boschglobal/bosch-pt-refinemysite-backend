...
import com.bosch.pt.csm.application.security.NoOpAuditorAware
...
class JpaConfigAuditorAwareRestore {
   ...
   */
  @Bean fun auditorProvider(): NoOpAuditorAware = NoOpAuditorAware()
}
