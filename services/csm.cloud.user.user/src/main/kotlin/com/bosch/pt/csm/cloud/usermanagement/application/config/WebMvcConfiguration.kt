...
import com.bosch.pt.csm.cloud.usermanagement.common.facade.rest.RegisteredUserPrincipalResolver
import com.bosch.pt.csm.cloud.usermanagement.common.facade.rest.UnregisteredUserPrincipalResolver
...
class WebMvcConfiguration(
  ...
  override fun addArgumentResolvers(resolvers: MutableList<HandlerMethodArgumentResolver>) {
    ...
    resolvers.add(RegisteredUserPrincipalResolver())
    resolvers.add(UnregisteredUserPrincipalResolver())
