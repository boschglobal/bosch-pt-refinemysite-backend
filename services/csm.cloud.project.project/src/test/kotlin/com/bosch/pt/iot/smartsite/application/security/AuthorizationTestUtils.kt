...
object AuthorizationTestUtils {
  ...
  fun doWithAuthorization(user: User?, procedure: Runnable) =
      doWithAuthorization(user, false, procedure)

  fun doWithAuthorization(userAdminPair: Pair<User?, Boolean>, procedure: Runnable) =
      doWithAuthorization(userAdminPair.left, userAdminPair.right, procedure)

  fun doWithAuthorization(user: User?, isAdmin: Boolean, procedure: Runnable) {
