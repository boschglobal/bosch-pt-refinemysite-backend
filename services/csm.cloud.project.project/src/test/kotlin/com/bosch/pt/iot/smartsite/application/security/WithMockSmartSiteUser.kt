...
annotation class WithMockSmartSiteUser(
    ...
    /**
     * The position to be used. The default is "".
     *
     * @return the position
     */
    val position: String = "",
    ...
    /**
     * The registered status to be used. The default is true.
     *
    ...
    /**
     * The status whether the user is locked. The default is false.
     *
    ...
    /**
     * The optional country of the user. Has to be a value from [IsoCountryCodeEnum]
     *
     * @return the country as [IsoCountryCodeEnum]
     */
    val country: String
)
