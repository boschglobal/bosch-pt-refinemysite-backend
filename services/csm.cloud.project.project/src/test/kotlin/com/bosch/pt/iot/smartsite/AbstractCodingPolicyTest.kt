...
import com.tngtech.archunit.core.domain.JavaModifier.BRIDGE
...
open class AbstractCodingPolicyTest {
  ...
  private fun checkAnnotationArchCondition(type: Class<out Annotation>, matches: Boolean) =
      object : ArchCondition<JavaMethod>("be annotated with " + type.name) {
        override fun check(method: JavaMethod, events: ConditionEvents) {
          val typeMatches =
  ...
  companion object {
    ...
    const val PACKAGE_ROOT = "com.bosch.pt.iot.smartsite."
