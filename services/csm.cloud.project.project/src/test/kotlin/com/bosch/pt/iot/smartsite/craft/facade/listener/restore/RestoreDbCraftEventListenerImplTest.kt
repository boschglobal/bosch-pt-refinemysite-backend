...
open class RestoreDbCraftEventListenerImplTest : AbstractRestoreIntegrationTestV2() {

  @Autowired private lateinit var craftEventListener: RestoreDbCraftEventListenerImpl
  ...
  open fun `validate fail if unknown tombstone event is received`() {
    ...
    assertThatExceptionOfType(IllegalArgumentException::class.java)
        .isThrownBy { craftEventListener.listenToCraftEvents(record, acknowledgement) }
