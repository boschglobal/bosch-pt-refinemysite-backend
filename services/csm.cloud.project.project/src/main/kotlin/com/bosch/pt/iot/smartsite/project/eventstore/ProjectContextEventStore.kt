...
@Component
open class ProjectContextEventStore(
    ...
    AbstractEventStore<ProjectContextKafkaEvent>(
        blockModifyingOperations, em, kafkaProperties, environment, schemaRegistryClient) {

  override fun getNameOfEventTopic() = kafkaTopicProperties.getTopicForChannel(PROJECT_BINDING)

  override fun getNumberOfPartitionsOfEventTopic() =
      kafkaTopicProperties.getConfigForChannel(PROJECT_BINDING).partitions
