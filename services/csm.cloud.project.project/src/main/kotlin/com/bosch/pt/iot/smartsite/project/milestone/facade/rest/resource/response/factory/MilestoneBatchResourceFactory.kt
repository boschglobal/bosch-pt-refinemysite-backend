...
@Component
open class MilestoneBatchResourceFactory(
    private val factoryHelper: MilestoneResourceFactoryHelper
) {

  open fun build(milestones: List<Milestone>, projectId: ProjectId) =
      BatchResponseResource(items = factoryHelper.build(milestones))
}
