...
class SaveTaskResourceWithIdentifierAndVersion(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is SaveTaskResourceWithIdentifierAndVersion) {
      return false
    }
    return id == other.id && version == other.version
  }

  @ExcludeFromCodeCoverage override fun hashCode(): Int = Objects.hash(id, version)
}
