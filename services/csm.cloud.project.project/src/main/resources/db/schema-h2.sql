    ...
    create table company (
        ...
        primary key (id),
        constraint UK_Company_Identifier unique (identifier)
    );
    ...
    create table craft (
        ...
        last_modified_by_id bigint not null,
        primary key (id),
        constraint UK_Craft_Identifier unique (identifier)
    );
    ...
    create table craft_translation (
        ...
        constraint UK_CRAFT_TRANSLATION_LANG unique (craft_id, locale)
    );
    ...
    create table day_card (
        ...
        last_modified_date timestamp(6) not null,
        version bigint not null,
        manpower numeric(38,2) not null,
        notes varchar(500),
        reason varchar(30) check (reason in ('DELAYED_MATERIAL','NO_CONCESSION','CONCESSION_NOT_RECOGNIZED','CHANGED_PRIORITY','MANPOWER_SHORTAGE','OVERESTIMATION','TOUCHUP','MISSING_INFOS','MISSING_TOOLS','BAD_WEATHER','CUSTOM1','CUSTOM2','CUSTOM3','CUSTOM4')),
        status varchar(10) not null check (status in ('OPEN','NOTDONE','DONE','APPROVED')),
        title varchar(100) not null,
        task_schedule_id bigint not null,
        primary key (id),
        constraint UK_DayCard_Identifier unique (identifier)
    );
    ...
    create table employee (
        ...
        primary key (id),
        constraint UK_Employee_Identifier unique (identifier)
    );

    create table employee_role (
        employee_id bigint not null,
        roles varchar(255) check (roles in ('CA','CR','CSM','FM'))
    );
    ...
    create table external_id (
        ...
        guid varchar(255),
        id_type tinyint not null check (id_type between 0 and 2),
        object_identifier varchar(255) not null,
        object_type varchar(255) not null check (object_type in ('WORKAREA','TASK','MILESTONE')),
    ...
    create table invitation (
        ...
        last_sent timestamp(6) not null,
        participant_identifier varchar(255) not null,
        project_identifier varchar(255) not null,
        primary key (id),
        constraint UK_Invitation_Identifier unique (identifier),
        constraint UK_Invitation_Part_Identifier unique (participant_identifier),
        constraint UK_Invitation_Email unique (project_identifier, email)
    );
    ...
    create table message (
        ...
        primary key (id),
        constraint UK_Message_Identifier unique (identifier)
    );
    ...
    create table milestone (
        ...
        work_area_id bigint,
        primary key (id),
        constraint UK_Milestone_Identifier unique (identifier)
    );
    ...
    create table milestone_list (
        ...
        work_area_id bigint,
        primary key (id),
        constraint UK_MilestoneList_Identifier unique (identifier),
        constraint UK_MilestoneList_SlotKey unique (project_id, date, header, work_area_id, work_area_id_constraint)
    );
    ...
    create table project (
        ...
        last_modified_date timestamp(6) not null,
        version bigint not null,
        category varchar(255) check (category in ('NB','OB','RB')),
        client varchar(100),
    ...
    create table project_craft (
        ...
        primary key (id),
        constraint UK_ProjCraftName_ProjCraftProj unique (name, project_id),
        constraint UK_ProjCraft_Identifier unique (identifier)
    );
    ...
    create table project_craft_list (
        ...
        primary key (id),
        constraint UK_ProjectCraftList_Identifier unique (identifier)
    );
    ...
    create table project_import (
        ...
        job_id varchar(255),
        project_identifier varchar(255) not null,
        read_working_areas_hierarchically boolean,
        status varchar(255) not null check (status in ('PLANNING','IN_PROGRESS','DONE','FAILED')),
        version bigint not null,
        work_area_column varchar(255),
        work_area_column_field_type varchar(255),
        primary key (id),
        constraint UK_ProjectImport_ProjectIdentifier unique (project_identifier)
    );
    ...
    create table project_participant (
        ...
        user_id bigint,
        primary key (id),
        constraint UK_ProjPart_Assignment unique (project_id, company_id, user_id),
        constraint UK_ProjPart_Identifier unique (identifier)
    );
    ...
    create table relation (
        ...
        source_type varchar(30) not null check (source_type in ('MILESTONE','TASK')),
        target_identifier varchar(36) not null,
        target_type varchar(30) not null check (target_type in ('MILESTONE','TASK')),
        type varchar(30) not null check (type in ('FINISH_TO_START','PART_OF')),
        created_by_id bigint not null,
        last_modified_by_id bigint not null,
        project_id bigint not null,
        primary key (id),
        constraint UK_Relation_Identifier unique (identifier),
        constraint UK_Relation unique (type, source_identifier, source_type, target_identifier, target_type),
        constraint UK_Relation_Search_All unique (project_id, type, identifier)
    );
    ...
    create table rfv_customization (
        ...
        rfv_key tinyint not null check (rfv_key between 0 and 13),
        name varchar(50),
        created_by_id bigint not null,
        last_modified_by_id bigint not null,
        project_id bigint not null,
        primary key (id),
        constraint UK_RfvCust_Identifier unique (identifier)
    );
    ...
    create table task (
        ...
        work_area_id bigint,
        primary key (id),
        constraint UK_Task_Identifier unique (identifier)
    );
    ...
    create table task_action_selection (
        ...
        primary key (id),
        constraint UK_TaskActionSelection_Identifier unique (identifier)
    );

    create table task_action_selection_set (
        task_action_selection_id bigint not null,
        action varchar(255) not null check (action in ('RESOURCES','INFORMATION','EQUIPMENT','MATERIAL','PRELIMINARY_WORK','SAFE_WORKING_ENVIRONMENT','EXTERNAL_FACTORS','COMMON_UNDERSTANDING','CUSTOM1','CUSTOM2','CUSTOM3','CUSTOM4')),
    ...
    create table task_attachment (
        ...
        topic_id bigint,
        primary key (id),
        constraint IX_TaskAttachment_Identifier unique (identifier)
    );
    ...
    create table task_constraint_customization (
        ...
        version bigint not null,
        active boolean not null,
        tsk_con_key tinyint not null check (tsk_con_key between 0 and 11),
        name varchar(50),
        created_by_id bigint not null,
        last_modified_by_id bigint not null,
        project_id bigint not null,
        primary key (id),
        constraint UK_TskConCust_Identifier unique (identifier)
    );
    ...
    create table task_schedule (
        ...
        task_id bigint not null unique,
        primary key (id),
        constraint UK_TaskSchedule_Identifier unique (identifier)
    );
    ...
    create table topic (
        ...
        last_modified_date timestamp(6) not null,
        version bigint not null,
        criticality varchar(30) not null check (criticality in ('CRITICAL','UNCRITICAL')),
        deleted bit not null default 0,
        description varchar(320),
        task_id bigint not null,
        primary key (id),
        constraint UK_Topic_Identifier unique (identifier)
    );

    create table user_country_restriction (
        id bigint generated by default as identity,
        country_code varchar(255) not null check (country_code in ('AD','AE','AF','AG','AI','AL','AM','AO','AQ','AR','AS','AT','AU','AW','AX','AZ','BA','BB','BD','BE','BF','BG','BH','BI','BJ','BL','BM','BN','BO','BQ','BR','BS','BT','BV','BW','BY','BZ','CA','CC','CD','CF','CG','CH','CI','CK','CL','CM','CN','CO','CR','CU','CV','CW','CX','CY','CZ','DE','DJ','DK','DM','DO','DZ','EC','EE','EG','EH','ER','ES','ET','FI','FJ','FK','FM','FO','FR','GA','GB','GD','GE','GF','GG','GH','GI','GL','GM','GN','GP','GQ','GR','GS','GT','GU','GW','GY','HK','HM','HN','HR','HT','HU','ID','IE','IL','IM','IN','IO','IQ','IR','IS','IT','JE','JM','JO','JP','KE','KG','KH','KI','KM','KN','KP','KR','KW','KY','KZ','LA','LB','LC','LI','LK','LR','LS','LT','LU','LV','LY','MA','MC','MD','ME','MF','MG','MH','MK','ML','MM','MN','MO','MP','MQ','MR','MS','MT','MU','MV','MW','MX','MY','MZ','NA','NC','NE','NF','NG','NI','NL','NO','NP','NR','NU','NZ','OM','PA','PE','PF','PG','PH','PK','PL','PM','PN','PR','PS','PT','PW','PY','QA','RE','RO','RS','RU','RW','SA','SB','SC','SD','SE','SG','SH','SI','SJ','SK','SL','SM','SN','SO','SR','SS','ST','SV','SX','SY','SZ','TC','TD','TF','TG','TH','TJ','TK','TL','TM','TN','TO','TR','TT','TV','TW','TZ','UA','UG','UM','US','UY','UZ','VA','VC','VE','VG','VI','VN','VU','WF','WS','YE','YT','ZA','ZM','ZW')),
        user_id varchar(255) not null,
        primary key (id),
        constraint UK_UserCountryRestriction_User_Country unique (user_id, country_code)
    );
    ...
    create table user_entity (
        ...
        user_id varchar(100),
        country varchar(255) check (country in ('AD','AE','AF','AG','AI','AL','AM','AO','AQ','AR','AS','AT','AU','AW','AX','AZ','BA','BB','BD','BE','BF','BG','BH','BI','BJ','BL','BM','BN','BO','BQ','BR','BS','BT','BV','BW','BY','BZ','CA','CC','CD','CF','CG','CH','CI','CK','CL','CM','CN','CO','CR','CU','CV','CW','CX','CY','CZ','DE','DJ','DK','DM','DO','DZ','EC','EE','EG','EH','ER','ES','ET','FI','FJ','FK','FM','FO','FR','GA','GB','GD','GE','GF','GG','GH','GI','GL','GM','GN','GP','GQ','GR','GS','GT','GU','GW','GY','HK','HM','HN','HR','HT','HU','ID','IE','IL','IM','IN','IO','IQ','IR','IS','IT','JE','JM','JO','JP','KE','KG','KH','KI','KM','KN','KP','KR','KW','KY','KZ','LA','LB','LC','LI','LK','LR','LS','LT','LU','LV','LY','MA','MC','MD','ME','MF','MG','MH','MK','ML','MM','MN','MO','MP','MQ','MR','MS','MT','MU','MV','MW','MX','MY','MZ','NA','NC','NE','NF','NG','NI','NL','NO','NP','NR','NU','NZ','OM','PA','PE','PF','PG','PH','PK','PL','PM','PN','PR','PS','PT','PW','PY','QA','RE','RO','RS','RU','RW','SA','SB','SC','SD','SE','SG','SH','SI','SJ','SK','SL','SM','SN','SO','SR','SS','ST','SV','SX','SY','SZ','TC','TD','TF','TG','TH','TJ','TK','TL','TM','TN','TO','TR','TT','TV','TW','TZ','UA','UG','UM','US','UY','UZ','VA','VC','VE','VG','VI','VN','VU','WF','WS','YE','YT','ZA','ZM','ZW')),
        deleted boolean not null,
        email varchar(255),
        ...
        constraint UK_User_Identifier unique (identifier),
    ...
    create table user_phonenumber (
        ...
        phone_number_type varchar(255) not null check (phone_number_type in ('ASSISTANT','BUSINESS','FAX','HOME','MOBILE','ORGANIZATION','OTHER','PAGER')),
    ...
    create table work_area (
        ...
        primary key (id),
        constraint UK_WorkAreaName_Project_Parent unique (name, project_id, parent),
        constraint UK_WorkArea_Identifier unique (identifier)
    );
    ...
    create table work_area_list (
        ...
        project_id bigint not null unique,
        primary key (id),
        constraint UK_WorkAreaList_Identifier unique (identifier)
    );
    ...
    create table workday_configuration_working_days (
        workday_configuration_project_id bigint not null,
        working_days varchar(12) not null check (working_days in ('MONDAY','TUESDAY','WEDNESDAY','THURSDAY','FRIDAY','SATURDAY','SUNDAY')),
    ...
    create table workday_configuration (
        ...
        last_modified_date timestamp(6) not null,
        version bigint not null,
        allow_work_on_non_working_days boolean not null,
        start_of_week varchar(12) not null check (start_of_week in ('MONDAY','TUESDAY','WEDNESDAY','THURSDAY','FRIDAY','SATURDAY','SUNDAY')),
        project_id bigint not null,
        primary key (project_id),
        constraint UK_WorkdayConfiguration_Identifier unique (identifier)
    );
    ...
    alter table if exists external_id 
    ...
    alter table if exists milestone_list 
    ...
    alter table if exists profile_picture 
    ...
    alter table if exists project_craft 
    ...
    alter table if exists project_craft 
       ...
       references project_craft_list;

    alter table if exists project_craft_list 
       add constraint FK_ProjectCraftList_Project 
       foreign key (project_id) 
       references project;

    alter table if exists project_participant 
    ...
    alter table if exists project_picture 
    ...
    alter table if exists rfv_customization 
    ...
    alter table if exists task 
       ...
       references project_participant;
    ...
    alter table if exists task_action_selection 
    ...
    alter table if exists task_constraint_customization 
    ...
    alter table if exists task_schedule 
    ...
    alter table if exists taskschedule_taskscheduleslot 
    ...
    alter table if exists user_craft 
    ...
    alter table if exists work_area 
    ...
    alter table if exists work_area 
       ...
       references work_area_list;

    alter table if exists work_area_list 
       add constraint FK_WorkAreaList_Project 
       foreign key (project_id) 
       references project;

    alter table if exists workday_configuration_holidays 
       add constraint FK_WorkdayConfiguration_Holidays 
       foreign key (workday_configuration_project_id) 
       references workday_configuration;

    alter table if exists workday_configuration_working_days 
       add constraint FK_WorkdayConfiguration_WorkingDays 
       foreign key (workday_configuration_project_id) 
       references workday_configuration;

    alter table if exists workday_configuration 
