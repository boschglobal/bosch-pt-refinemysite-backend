...
class WebMvcConfiguration(
  ...
  @Bean
  fun mdcFilter(): FilterRegistrationBean<MdcInsertingRequestParametersFilter> =
      FilterRegistrationBean(MdcInsertingRequestParametersFilter()).apply<
          FilterRegistrationBean<MdcInsertingRequestParametersFilter>> {
  ...
  fun exceptionMessageHideFilter(
      ...
      FilterRegistrationBean(ExceptionMessageHideFilter(messageSource)).apply<
          FilterRegistrationBean<ExceptionMessageHideFilter>> { order = HIGHEST_PRECEDENCE + 7 }
