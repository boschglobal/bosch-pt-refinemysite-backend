...
@RmsSpringBootTest
class MilestonePredecessorRelationGraphQlApiIntegrationTest : AbstractGraphQlApiIntegrationTest() {

  val predecessorMilestone = "projects[0].milestones[0].predecessorMilestones[0]"
  val predecessorTask = "projects[0].milestones[0].predecessorTasks[0]"
  ...
  @Test
  fun `query task predecessors of milestone`() {
    submitEvents()
  ...
  @Test
  fun `query milestone predecessors of milestone`() {
    submitEvents()
