...
import com.bosch.pt.csm.cloud.projectmanagement.common.i18n.Key.TOPIC_ACTIVITY_DELETED
import com.bosch.pt.csm.cloud.projectmanagement.common.i18n.Key.TOPIC_ACTIVITY_DELETED_WITHOUT_TEXT
...
@DisplayName("Verify topic deleted activity")
@SmartSiteSpringBootTest
class TopicDeletedActivityStrategyTest : AbstractActivityIntegrationTest() {
  ...
  fun `when the topic has description`() {
    eventStreamGenerator
        ...
        .submitTopicG2(eventType = DELETED)
    ...
    requestActivities(task)
        ...
        .andExpect(hasSummary(buildSummary(TOPIC_ACTIVITY_DELETED, true)))
  }

  @Test
  fun `when the topic does not have description`() {
    eventStreamGenerator.submitTopicG2 { it.description = null }.submitTopicG2(eventType = DELETED)
    ...
    requestActivities(task)
        ...
        .andExpect(hasDate(timeLineGenerator.time))
        .andExpect(hasUser(fmUser))
        .andExpect(hasSummary(buildSummary(TOPIC_ACTIVITY_DELETED_WITHOUT_TEXT, false)))
  }
