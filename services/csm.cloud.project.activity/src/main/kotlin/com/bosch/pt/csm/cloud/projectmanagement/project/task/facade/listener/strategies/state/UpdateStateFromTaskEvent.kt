...
import com.bosch.pt.csm.cloud.projectmanagement.project.task.facade.listener.message.toEntity
...
class UpdateStateFromTaskEvent(private val taskService: TaskService) :
  ...
  override fun updateState(key: EventMessageKey, event: TaskEventAvro) =
      event.getAggregate().run {
        ...
        taskService.save(toEntity(projectIdentifier))
        taskService.deleteByVersion(
