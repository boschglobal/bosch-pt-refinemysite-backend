...
import com.bosch.pt.csm.cloud.projectmanagement.project.taskschedule.facade.listener.message.toEntity
...
class UpdateStateFromTaskScheduleEvent(private val taskScheduleService: TaskScheduleService) :
  ...
  override fun updateState(key: EventMessageKey, event: TaskScheduleEventAvro) =
      event.getAggregate().run {
        ...
        taskScheduleService.save(toEntity(projectIdentifier))
        taskScheduleService.deleteByVersion(
